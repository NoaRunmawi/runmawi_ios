   ...
   //await FlutterWindowManager.addFlags(FlutterWindowManager.FLAG_SECURE);
    ...
    try {
      ...
      //  int buffer =100000;
        ...
        // var wvLicenseUri=streamApiHostName+"/WidevineLicense/"+libraryId+"/"+videoId;
        // var fpCertificateUri=streamApiHostName+"/FairPlay/"+libraryId+"/certificate";
        //
        // var fpLicenseUri=streamApiHostName+"/FairPlay/"+libraryId+"/license/?videoId="+videoId;
        //
        // var manifestUri ="https://"+storageZoneId+"."+storageDomain+"/"+videoId+"/playlist.m3u8";


        const streamApiHostName="https://video.bunnycdn.com";
        const libraryId=270162;
        const videoId="cdfef2d6-b027-40fd-9ce1-a765d31c22c9";
        ...
        BetterPlayerDataSource dataSource= BetterPlayerDataSource(
          BetterPlayerDataSourceType.network,
            ...
            drmConfiguration: BetterPlayerDrmConfiguration(
              drmType: BetterPlayerDrmType.fairplay, // FairPlay DRM type
              certificateUrl: Constants.fairplayCertificateUrl, // URL for the FairPlay certificate
              licenseUrl: Constants.fairplayLicenseUrl, // URL for the FairPlay license
          ...
          child: SingleChildScrollView(
            child: isLoading && movieModel == null
              ...
              children: [
                ...
                movieModel!.data![0].super_user.toString()=="1"?
...
class Constants {
  ...
  static const String hlsPlaylistUrl =
      "https://vz-408b4d55-9c6.b-cdn.net/cdfef2d6-b027-40fd-9ce1-a765d31c22c9/playlist.m3u8";
  ...
  static String fairplayCertificateUrl =
      "https://video.bunnycdn.com/FairPlay/270162/certificate";
  static String fairplayLicenseUrl = "https://video.bunnycdn.com//FairPlay/270162/license/?videoId=cdfef2d6-b027-40fd-9ce1-a765d31c22c9";
