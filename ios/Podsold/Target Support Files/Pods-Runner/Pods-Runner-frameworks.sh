...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/vdocipher_flutter/vdocipher_flutter.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/VdoFramework/VdoFramework.framework"
